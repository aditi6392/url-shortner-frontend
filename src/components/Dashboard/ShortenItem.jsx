...
// import Loader from '../Loader'; // ✅ Using custom loader instead of Vortex
...
//                     <div
//                         onClick={handleCopy}
//                         className="flex cursor-pointer gap-1 items-center bg-blue-950 py-2 font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white"
//                     >
...
//                         className="flex cursor-pointer gap-1 items-center bg-rose-900 py-2 font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white"
//                     >
...
//                                 <Loader /> {/* ✅ Replaced Vortex with Loader */}
...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
    ...
    // ✅ Safe access to env variable with fallback
