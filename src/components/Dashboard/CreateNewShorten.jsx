...
import { data } from "autoprefixer"; // your original import (though it's unused)
...
const CreateNewShorten = ({ setOpen, refetch }) => {
  ...
  return (
   ...
   <button
          className="bg-blue-900 font-semibold text-white w-32  bg-custom-gradient  py-2  transition-colors  rounded-md my-3"
          type="text"
        >
